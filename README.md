...
Audits from [Google Lighthouse](https://developer.chrome.com/docs/lighthouse/overview/) are
performed on every deployment of the website. Here are the results of the latest execution:
