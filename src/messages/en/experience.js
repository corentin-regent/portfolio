...
const leaguesggIntern = {
  'text-leagues-intern-until-webapp-link':
    'As a part of my studies, I did an internship abroad in Denmark, in the start-up behind the ',
  'text-leagues-intern-until-lol-player-page':
    ' website. I implemented many pages and features alongside the team, notably ',
...
const sncfSis = {
  'text-sncf-sis':
    'During the first year of my apprenticeship, I developed web applications for the French National Railroad Company, for a project called "Information Systems for Supervision" (of trains). Those are the applications that the agents use for monitoring and planning in real time the entire railway traffic across France and neighboring regions. It was my first professional experience as a software engineer, and initially I knew nothing about web development. So, I invested a lot into building up my skills, with a strong support from my team, and I ended up being responsible notably for writing technical conceptions of complex functionalities.',
};
...
const polytechPeip = {
  ...
  'text-polytech-peip-before-math-eg':
    'I followed a two-year general preparatory class before the engineering cycle, during which I acquired rock-solid knowledge in various fields of mathematics ',
  ...
  'text-polytech-peip-after-physics-eg':
    '. I was the valedictorian, and ranked 3ʳᵈ out of 1567 students in the national ranking of the Polytech schools network.',
};
