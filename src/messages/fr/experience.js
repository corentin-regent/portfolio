...
const pageMessages = {
  ...
  'page-main-text': "Vous trouverez ici les différentes étapes de ma carrière en tant qu'ingénieur en informatique.",
...
const sopraSteriaApprentice = {
  'text-sopra-steria-apprentice': "J'ai travaillé à Sopra Steria pendant les trois années de mon apprentissage, pour plusieurs clients de grande envergure. J'ai volontairement changé de projet plusieurs fois, afin d'acquérir davantage de compétences dans différents contextes ; ces expériences sont détaillées ci-dessous.",
}

const geodisData = {
  'text-geodis-data': "Je développe actuellement une infrastructure distribuée d'entreposage de données pour Geodis, une entreprise multinationale de logistique qui est divisée en différentes entités sans avoir de système d'information commun. J'ingère et effectue divers traitements sur les données provenant de ces différentes entités, afin de calculer des indicateurs de performance globaux notamment. Je me charge également de la relecture et du test des travaux de mes collègues. Par ailleurs, je m'efforce d'automatiser les tâches répétitives dans nos processus de développement."
};

const sncfTrace = {
  'text-sncf-trace': "J'ai développé une application web interne pour la SNCF, grâce à laquelle les gestionnaires de l'entreprise peuvent accéder à divers rapports financiers. Étant le seul développeur front-end travaillant sur ce projet, j'ai également implémenté des tests d'intégration robustes et des mesures de cybersécurité, supervisé par un responsable technique.",
}

const leaguesggIntern = {
  'text-leagues-intern-until-webapp-link': "Dans le cadre de mes études, j'ai réalisé un stage à l'étranger au Danemark, dans la start-up derrière le site ",
  'text-leagues-intern-until-lol-player-page': ". J'ai implémenté de nombreuses pages et fonctionnalités aux côtés de l'équipe, comme notamment ",
  'text-leagues-intern-lol-player-page': 'les pages de profil des joueurs de League of Legends',
  'text-leagues-intern-until-successfully-hosted': ", et ai conçu toute l'infrastructure back-end pour interagir avec les APIs externes, comprenant l'authentification des joueurs, la limitation du débit des requêtes et la mise en cache des réponses. À la fin de l'été, ",
  'text-leagues-intern-successfully-hosted': 'Leagues.gg a accueilli avec succès la branche danoise du Championnat Nordique de League of Legends',
...
const polytechPeip = {
  ...
  'text-polytech-peip-before-math-eg': "J'ai suivi une classe préparatoire généraliste de deux ans avant le cycle ingénieur, au cours de laquelle j'ai acquis des compétences solides dans divers domaines des mathématiques ",
  ...
  'text-polytech-peip-after-physics-eg': ". J'étais le major de la promotion et me suis classé 3ᵉ sur 1567 étudiants dans le classement national du réseau des écoles Polytech.",
};
